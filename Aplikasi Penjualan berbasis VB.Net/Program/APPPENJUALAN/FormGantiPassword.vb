...
Public Class FormGantiPassword
    ...
    Private Sub TextBox1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox1.KeyPress
        If e.KeyChar = Chr(13) Then
            Call Koneksi()
            Cmd = New OdbcCommand("Select * From tb_admin where kodeadmin='" & FormMenuUtama.STLabel2.Text & "' and  passwordadmin ='" & TextBox1.Text & "'", Conn)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Else
                Call Koneksi()
                Dim EditPass As String = "Update tb_admin set passwordadmin='" & TextBox3.Text & "' where kodeadmin = '" & FormMenuUtama.STLabel2.Text & "'"
